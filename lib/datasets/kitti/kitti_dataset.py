...
class KITTI_Dataset(data.Dataset):
    def __init__(self, split, cfg):
        ...
        self.idx_list = [x.strip() for x in open(self.split_file).readlines()]  # list of id in dataset
        ...
        self.aug_pd = cfg.get('aug_pd', False)  # True
        self.aug_crop = cfg.get('aug_crop', False)  # True
        self.aug_calib = cfg.get('aug_calib', False)  # False

        self.random_flip = cfg.get('random_flip', 0.5)
        self.random_crop = cfg.get('random_crop', 0.5)
        self.scale = cfg.get('scale', 0.4)  # 0.05
        self.shift = cfg.get('shift', 0.1)  # 0.05
