...
parser = argparse.ArgumentParser(description='Depth-DETR')
...
def main():
    ...
    cfg = yaml.load(open(args.config, 'r'), Loader=yaml.Loader)  # cfg save as dict
    ...
    # build dataloader
    train_loader, test_loader = build_dataloader(cfg['dataset'])  # workers=4
